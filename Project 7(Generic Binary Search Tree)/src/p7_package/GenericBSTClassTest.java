/**
 * Generic BST Class Testing Class
 * 
 * CS 249 
 * 
 * DUE: 3-26-19
       ...
       try
          {
           ...
           removedItem = removeState( testClass, "North Carolina" );
           // fill in state name
           System.out.println( removedItem.toString() );
           assertEquals( removedItem.toString(), "State Name: North Carolina,"
           		+ " Population: 10383620" ); // fill in string result

           // remove node with ONLY LEFT NODE
           removedItem = removeState( testClass, "Maine" ); 
           // fill in state name
           System.out.println( removedItem.toString() );
           assertEquals( removedItem.toString(), "State Name: Maine,"
           		+ " Population: 1338404" ); // fill in string result

           // remove node with TWO CHILDREN
           removedItem = removeState( testClass, "Nevada" );
           // fill in state name          
           System.out.println( removedItem.toString() );
           assertEquals( removedItem.toString(), "State Name: Nevada,"
           		+ " Population: 3034392" ); // fill in string result
           
           // remove node not available
           System.out.println( removedItem.toString() );
           removedItem = removeState( testClass, "Alabama" ); 
           // fill in state name           
